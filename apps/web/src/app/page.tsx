  ...
  return (
    <div className="max-w-3xl mx-auto px-4 pt-10 pb-16">
      ...
      <div className="flex flex-col items-center">
        ...
        {/* Dino eating the input — horizontal layout */}
        <div className="relative w-full max-w-xl">
          {/* Input row with dino on the right */}
          <div className="flex items-center gap-0">
            {/* Input — the food */}
            <div
              className={`flex-1 relative z-10 transition-transform ${
                chomping ? "animate-chomp" : ""
              }`}
            >
              <div className="bg-white border-2 border-gray-200 rounded-2xl rounded-r-none p-1.5
            ...
            {/* Dino — standing to the right, mouth facing the input */}
            <div
              className={`relative z-20 -ml-3 ${loading ? "" : "animate-float"}`}
              style={{ transform: "scaleX(-1)" }}
            >
              <Dino state={loading ? "chewing" : "idle"} size={140} />
            </div>
          </div>
